...
const TRASH_LABELS={
  lt_cols_v1:'Egg collection', lt_birds_v1:'Flock record', lt_feed_v1:'Feed record',
  lt_health_v1:'Health record', lt_expenses_v1:'Expense', lt_sales_v1:'Sale',
  lt_recv_v1:'Receivable', lt_customers_v1:'Customer', lt_payments_v1:'Payment',
  lt_feedstock_v1:'Feed store entry'
};
...
function initApp(){
  ...
  console.log('LayerTrack build v'+APP_VERSION);
}
